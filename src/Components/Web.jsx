...
export default function Web() {
  return (
    ...
    <body>
        ...
        <div id="spinner" classNameName="show w-100 vh-100 bg-white position-fixed translate-middle top-50 start-50  d-flex align-items-center justify-content-center">
                        ...
                        <div className="position-relative">
                            ...
                            <div className="d-flex align-items-center flex-nowrap">
                                <div className="bg-secondary rounded">
                                    <img src="img/testimonial-1.jpg" className="img-fluid rounded" style={{height:"100px",width:"100px"}} alt=""/>
                                </div>
